...
plot(pca.out$x[,c(1,2)], col=Cols(train.data$Item_Outlet_Sales), pch=19,xlab="Z1",ylab="Z2")
plot(pca.out$x[,c(1,3)], col=Cols(train.data$Item_Outlet_Sales), pch=19,xlab="Z1",ylab="Z2")
